...
#ifndef BOOKBOT_TRAJECTORY_FOLLOWING_CONTROLLER_INTROSPECTION_H_
#define BOOKBOT_TRAJECTORY_FOLLOWING_CONTROLLER_INTROSPECTION_H_
...
#endif  // BOOKBOT_TRAJECTORY_FOLLOWING_CONTROLLER_INTROSPECTION_H_
